...
namespace Prototype.NetworkLobby {
    ...
    public class LobbyManager : NetworkLobbyManager {
        ...
        public void CreateMatchmakingGame (string matchName) {
        ...
        public override void OnMatchList (bool success, string extendedInfo, List<MatchInfoSnapshot> matchList) {
            ...
            if (matchList.Count > 0)
                JoinMatch(matchList[0].networkId);
            else
                 CreateMatchmakingGame("QuickMatchGame");

        }

        public static void JoinMatch (NetworkID networkID) {

            s_Singleton.matchMaker.JoinMatch(networkID, "", "", "", 0, 0, s_Singleton.OnMatchJoined);
            s_Singleton.backDelegate = s_Singleton.StopClientClbk;
            s_Singleton._isMatchmaking = true;
            s_Singleton.DisplayIsConnecting();
        ...
        public override GameObject OnLobbyServerCreateLobbyPlayer(NetworkConnection conn, short playerControllerId) {
            ...
            obj.GetComponent<LobbyPlayer>().ToggleJoinButton(numPlayers + 1 >= minPlayers);
